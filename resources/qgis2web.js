...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 26, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_MonevIrigasiCitarum2022_3,
      colName: 'Paket',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([107.097397, -6.608596, 108.211452, -5.867270], map.getSize());
